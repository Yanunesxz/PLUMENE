...
10. **Cores são internas:** nada muda (continuam na observação do item, `cor` sempre `00001`). Desde 22/09/2026 o texto da observação traz o **número da bolinha do catálogo** (`"Cor 2"`, `"3M Cor 2 / 2G Cor 1"`, `"Variadas"`, `"Cor única"`) no lugar do nome — pedido do Yan para o estoque; o app continua mostrando o nome.
